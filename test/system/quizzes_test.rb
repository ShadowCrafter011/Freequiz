...
class QuizzesTest < ApplicationSystemTestCase
  test "creating a quiz" do
    ...
    find_test_id("from-lang").find(:option, text: t("general.languages.#{lang_from.locale}")).select_option
    find_test_id("to-lang").find(:option, text: t("general.languages.#{lang_to.locale}")).select_option
